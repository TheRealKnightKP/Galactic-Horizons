...
const SHIPS = {
  ...
  // --- SECRET ---
  Comet:      { price: null,      hp: 100,   shields: 90,   armor: 100, missiles: 30,  speed: 4.0,  weaponType: "ballistic_cannon",  weaponSize: 5,  bespoke: true,  doubleShot: false, pdc: 0,  pdcSize: 0,     image: "Meteor.png",           color: "#ff2200", size: 1,  missileType: 2, armorType: "light",      secret: true, allySlots: ["small","small","medium","medium"],
  ...
  Retribution:{ price: null,      hp: 600,   shields: 500,  armor: 100, missiles: 20,  speed: 3.0,  weaponType: "ballistic_cannon",  weaponSize: 10, bespoke: true,  doubleShot: false, burstFire: true, burstCount: 3, pdc: 3, pdcSize: 5, image: "Meteor.png", color: "#ff4400", size: 3,  missileType: 3, armorType: "heavy",      secret: true, allySlots: ["small","medium","heavy","heavy","heavy","capital"],
